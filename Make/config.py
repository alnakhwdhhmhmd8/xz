...
LOGGER_ID = int(getenv("LOGGER_ID", -1002863068588))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BLAKAQ",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)  
# Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/xvwwvl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/xvwwvl")
